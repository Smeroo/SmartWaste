...
import { userRegisterSchema, userRegisterSchemaOAuth } from "@/lib/zod";
...
export default function UserForm({
    ...
    const {
        ...
        resolver: zodResolver(
            useOAuth ? userRegisterSchemaOAuth : userRegisterSchema
        ) as unknown as Resolver<
            typeof useOAuth extends true ? UserOAuthFormValues : UserFormValues
        >,
    });
